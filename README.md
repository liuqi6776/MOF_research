...
4. **Predictive QSAR Models / 构效关系预测**: Tree-based ensembles achieved $R^2 pprox 0.74 - 0.78$ across all performance dimensions, highlighting Pore Limiting Diameter (PLD $3.5-5.5 	ext{ Å}$), Surface Area (ASA), and Open Metal Sites (OMS) as primary governing factors.
